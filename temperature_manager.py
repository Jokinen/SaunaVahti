...
class TEMP_manager:
    ...
    def estimate_time(self):
        ...
        average_increase = reduce(lambda x,y: x + y['temp'], self.recorded_temps) / len(self.recorded_temps)
        average_time = reduce(lambda x,y: x + y['time'], self.recorded_temps) - self.recorded_temps[0]['time']
